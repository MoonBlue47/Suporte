...
public class PainelTecnicoController {
	...
	@PostMapping("/assumir/{id}")
	public String assumir(@PathVariable Long id,
						  @RequestParam String tecnicoResponsavel,
						  @RequestParam(required = false) String observacoes,
						  RedirectAttributes flash) {
		try {
			painelTecnicoService.assumir(id, tecnicoResponsavel, observacoes);
			flash.addFlashAttribute("sucesso", "Chamado assumido com sucesso! Status atualizado para Em Andamento.");
